...
class PerangkatUtamaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        PerangkatUtama::create([
            ...
            'ram_kapasitas'   => (int) preg_replace('/[^0-9]/', '', $request->ram_kapasitas),
            'ssd_merk'        => $request->ssd_merk,
            'ssd_kapasitas'   => (int) preg_replace('/[^0-9]/', '', $request->ssd_kapasitas),
            'hdd_merk'        => $request->hdd_merk,
            'hdd_kapasitas'   => (int) preg_replace('/[^0-9]/', '', $request->hdd_kapasitas),
